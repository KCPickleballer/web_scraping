...
def nasaMarsNews():
    ...
    #return marsNews
    ## just getting the most recent for now and returning it as a tuple
...
def scrape():
    ...
    mars_weather = weatherTweet()
    marFacts_html_tbl_str = marsFacts()
    #print(marFacts_html_tbl_str)
    hemiTup = marsHemis()
    print(hemiTup)
    #print(hemisphere_image_urls)
    featuredImgTitle = 'Juno Captures Elusive'
    featuredImg = 'https://www.jpl.nasa.gov/spaceimages/images/wallpaper/PIA22688-640x350.jpg'

    mars_info = { "mars_weather": mars_weather,
                 "mars_news_title": marsNewsTuple[0],
         "mars_news_para": marsNewsTuple[1],
         "featured_img":   featuredImg,
         "featured_img_title": featuredImgTitle,
         "marsFacts_table":  marFacts_html_tbl_str,
         "hem1_img": hemiTup[0][0],
         "hem2_img": hemiTup[0][1],
         "hem3_img": hemiTup[0][2],
         "hem4_img": hemiTup[0][3],
         "hem1_title": hemiTup[1][0],
         "hem2_title": hemiTup[1][1],
         "hem3_title": hemiTup[1][2],
         "hem4_title": hemiTup[1][3]
    }
    print("mars_info:")
    print(mars_info)
    return(mars_info)
